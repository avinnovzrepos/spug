...
function onConnect(socket) {
  ...
  // require('../api/user/user/user.socket').register(socket);
  // require('../api/user/user-history/user-history.socket').register(socket);
  // require('../api/user/login-history/login-history.socket').register(socket);

  // require('../api/inventory/inventory/inventory.socket').register(socket);
  // require('../api/inventory/inventory-history/inventory-history.socket').register(socket);
}
